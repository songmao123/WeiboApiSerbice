 ...
 */
public class FavoriteStatusAdapter extends BaseQuickAdapter<FavoriteStatus> implements View.OnClickListener {
    ...
    public FavoriteStatusAdapter(Context context, int layoutResId, List<FavoriteStatus> data) {
        super(layoutResId, data);
        this.mImageShowUtil = new ImageShowUtil(context);
        this.context = context;
    }
    @Override
    protected void convert(BaseViewHolder helper, final FavoriteStatus favoriteStatus) {
        final WeiboStatus weiboStatus = favoriteStatus.getStatus();
        ...
        helper.setText(R.id.status_publish_time_tv, "收藏于 " + TimeLineUtil.getFormatTime(favoriteStatus.getFavorited_time()));
//        helper.setText(R.id.status_from_tv, Html.fromHtml(weiboStatus.getSource()).toString());
        helper.setVisible(R.id.status_from_tv, false);
        helper.setVisible(R.id.from_text_tv, false);
